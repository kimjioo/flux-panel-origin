...
面板端：
```bash
curl -L https://raw.githubusercontent.com/kimjioo/flux-panel-origin/refs/heads/main/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh

```

节点端：
```bash
curl -L https://raw.githubusercontent.com/kimjioo/flux-panel-origin/refs/heads/main -o install.sh && chmod +x install.sh && ./install.sh
